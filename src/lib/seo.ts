...
type PageTwitterMeta = {
  ...
  site?: string; // twitter handle (@username) of article owner
  creator?: string; // twitter handle (@username) of content owner (usually same as article owner)
...
type BlogPostTwitterMeta = {
  title: string; // same as article post og:title
  description?: string; // same as article post og:description
  card: 'summary_large_image';
  site?: string; // twitter handle (@username) of article owner
  creator?: string; // twitter handle (@username) of content owner (usually same as article owner)
  image?: string; // same as article post  og:image
  imageAlt?: string; // same as article post  og:image:alt
};
